...
namespace Dev.Tools.Web.Core.Cryptography;

internal sealed class WebAssemblyMd5 : IMd5Hash
{
    ...
    public string ComputeHashString(byte[] input) => string.Join("", ComputeHash(input).Select(o => o.ToString("x2")));
